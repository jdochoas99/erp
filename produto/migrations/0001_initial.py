# Generated by Django 3.1.2 on 2020-11-04 00:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='unidade', to='produto.categoriaproduto')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='produto',
            name='subcategoria',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='unidade', to='produto.subcategoriaproduto'),
        ),
        migrations.AddField(
            model_name='produto',
            name='tipoDeItem',
